...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "1.9.5"
  WORKING_DIRECTORY "C:/CS/year3/projects/schedulify/Schedulify/build-server/_deps/jsoncpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/CS/year3/projects/schedulify/Schedulify/build-server/_deps/jsoncpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/CS/year3/projects/schedulify/Schedulify/build-server/_deps/jsoncpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
